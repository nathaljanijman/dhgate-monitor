...
// .wrangler/tmp/bundle-F7JstK/strip-cf-connecting-ip-header.js
  ...
  return `
            ...
            <div class="navbar-container" style="display: flex; justify-content: space-between; align-items: center; padding: 1rem 0;">
                <a href="/?lang=${lang}&theme=${theme}" class="navbar-brand" style="text-decoration: none; display: flex; align-items: center; gap: 0.5rem;">
                    <div class="brand-logo">
                        <img src="/assets/logo.png" alt="DHgate Monitor" width="40" height="40" style="border-radius: 6px; background: transparent;">
                    </div>
    ...
    <div class="mobile-menu" id="mobileMenu" style="display: none; position: fixed; top: 0; right: -100%; width: 280px; height: 100%; background: var(--card-bg); z-index: 9999; transition: right 0.3s ease; padding: 2rem 1.5rem; box-shadow: -5px 0 20px rgba(0, 0, 0, 0.1);">
        <div class="mobile-menu-header" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem; padding-bottom: 1rem; border-bottom: 1px solid var(--border-color);">
            <div class="brand-logo">
                <img src="/assets/logo.png" alt="DHgate Monitor" width="32" height="32" style="border-radius: 4px; mix-blend-mode: multiply; filter: contrast(1.2) brightness(1.1);">
            </div>
...
<body data-page-type="landing">
    ...
    <nav class="professional-navbar">
        <div class="navbar-container">
            <a href="/?lang=${lang}&theme=${theme}" class="navbar-brand">
                <div class="brand-logo" style="width: 40px; height: 40px; display: flex; align-items: center; justify-content: center;">
                    <img src="/assets/logo.png" alt="DHgate Monitor" width="40" height="40" style="border-radius: 6px;">
                </div>
    ...
    <div class="mobile-menu" id="mobileMenu">
        <div class="mobile-menu-header">
            <div class="brand-logo" style="width: 32px; height: 32px; display: flex; align-items: center; justify-content: center;">
                <img src="/assets/logo.png" alt="DHgate Monitor" width="32" height="32" style="border-radius: 4px;">
            </div>
...
// .wrangler/tmp/bundle-F7JstK/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-F7JstK/middleware-loader.entry.ts
