...
// .wrangler/tmp/bundle-BO8JGS/strip-cf-connecting-ip-header.js
...
async function handleAsset(pathname, corsHeaders) {
  ...
  if (pathname === "/assets/logo.svg") {
    try {
      ...
      console.log("Failed to fetch horizontal logo from GitHub:", error3);
    }
  }
        ...
        <div class="container">
            <div class="section-header" style="text-align: center; margin-bottom: 3rem;">
                <h2 class="section-title" style="font-size: 2.2rem; font-weight: 700; color: var(--text-primary); margin-bottom: 1rem;">
                    ${lang === "nl" ? "Populaire shop categorie\xEBn" : "Popular shop categories"}
                </h2>
                <p class="section-subtitle" style="font-size: 1.1rem; color: var(--text-secondary); max-width: 500px; margin: 0 auto;">
                    ${lang === "nl" ? "Monitor de meest populaire productcategorie\xEBn op DHgate" : "Monitor the most popular product categories on DHgate"}
                </p>
            </div>
...
// .wrangler/tmp/bundle-BO8JGS/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-BO8JGS/middleware-loader.entry.ts
